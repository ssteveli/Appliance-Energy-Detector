...
public class AlgorithmResult {
	...
	public AlgorithmResult(EnergyMonitor monitor, ApplianceEnergyConsumptionDetectionAlgorithm algorithm, Serializable result) {
		this.result = result;
	...
	public ApplianceEnergyConsumptionDetectionAlgorithm getAlgorithm() {
		return algorithm;
	}
