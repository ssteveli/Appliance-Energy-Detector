...
public class OAuthUserDetails implements UserDetails {
	...
	private Map<String,OAuthConsumerToken> oAuthTokens;
	
	public OAuthUserDetails(String username, String email, Map<String,OAuthConsumerToken> oAuthTokens) {
	...
	public Map<String,OAuthConsumerToken> getOAuthTokens() {
		return oAuthTokens;
	}
}
